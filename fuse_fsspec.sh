...
ETCD_HOSTS="172.16.20.157"
ETCD_PORT=32684
CLUSTER_NAME="inferless-demo"
...
FILE_SIZE=("1MB" "1GB" "10GB")
BS=("256KB")
NUMJOBS=("1" "4" "8")

# alluxio-fuse
FUSE_PATH="/mnt/fuse/nfs/alluxiofs"
FUSE_RW=("read")


# alluxio-fsspec
FSSPEC_REMOTE_PATH_READ="file:///ufs/data/alluxiofs/fsspec/read"
FSSPEC_REMOTE_PATH_WRITE="file:///ufs/data/alluxiofs/fsspec/write"
